...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if($num < 1)
    {
        ...
        $sql="UPDATE registeration SET mobilenumber='$mobilenumber' WHERE name='$name'";
...
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Success</strong> Your Number is changed.
...
<div class="container">
    ...
    <input type="text" name="mobilenumber" placeholder="Enter New Number"required/>
    <div class="w3-center">
